...
func (c *userServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/agwd.user.v1.UserService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/agwd.user.v1.UserService/Create",
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agwd.user.v1.UserService",
	...
	Metadata: "agwd/user/v1/user.proto",
}
